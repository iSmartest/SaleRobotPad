...
public class Url {
    //服务器地址
//    public static final String HTTP ="http://101.200.60.12:8080/robot-manager-web/robot/pai/car";
    public static final String HTTP ="http://192.168.1.6:8080/robot-manager-web/pai/car";
