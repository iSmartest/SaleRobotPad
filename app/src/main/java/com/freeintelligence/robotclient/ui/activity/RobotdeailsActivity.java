...
public class RobotdeailsActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        final RobotconsultBean.DataBean.CarListBean.AnswersBean answersBean = (RobotconsultBean.DataBean.CarListBean.AnswersBean) getIntent().getSerializableExtra("robot");
    ...
    public class ImageAdapter extends PagerAdapter {
        ...
        private List<RobotconsultBean.DataBean.CarListBean.AnswersBean.PicsBean> mShopImgList;

        public ImageAdapter(Context mContext, List<RobotconsultBean.DataBean.CarListBean.AnswersBean.PicsBean> mShopImgList) {
