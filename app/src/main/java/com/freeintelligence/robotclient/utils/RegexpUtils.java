...
public class RegexpUtils {
    ...
    public static final boolean isMobileNO(String mobiles) {
       /* Pattern p = Pattern
        ...
        //String telRegex = "^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\\\\d{8}$";//"[1]"代表第1位为数字1，"[358]"代表第二位可以为3、5、8中的一个，"\\d{9}"代表后面是可以是0～9的数字，有9位。
